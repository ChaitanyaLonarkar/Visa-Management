            ...
            <div className="table">
              <table className="table-auto text-left text-sm w-full text-gray-800   ">
                <thead className="w-full bg-gradient-to-r from-gray-300  ">
                  <tr className=" ">
                    <th scope="col" className=" font-semibold px-4 py-3">Entry</th>
                    <th scope="col" className=" font-semibold px-4 py-3" >Validity</th>
                    <th scope="col" className=" font-semibold px-4 py-3" >Duration</th>
                    <th scope="col" className=" font-semibold px-4 py-3" >Documents</th>
                    <th scope="col" className=" font-semibold px-4 py-3" >Proccesing Time</th>
                    <th className=" text-lg text-slate-800">
                    &#8377; 12780 /<span className=" font-normal text-base">per pax</span>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-3 text-cyan-600" ><Link>View here</Link></td>
